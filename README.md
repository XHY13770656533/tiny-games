...
- 已提供两个可玩游戏：电子宠物、井字棋
- 电子宠物支持 3 个小动物形象、真实互动动画、空闲行为动画和鼠标追踪/追逐互动
- 已预留翻牌记忆、贪吃蛇、2048、扫雷、打砖块、转盘大作战等游戏目录和路由
- 转盘大作战已完成策划案：`docs/games/wheel-battle.md`（自动塔防空战，战中只选时机转动，局后金币养成）
...
1. 继续打磨电子宠物：补充更多可解锁外观、场景物件和触控端手势
